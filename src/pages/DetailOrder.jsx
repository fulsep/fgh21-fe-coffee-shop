          ...
          <div className="flex flex-col md:w-1/2 pr-2">
            ...
            <div className="flex items-center p-4 gap-2 border-b-2">
              ...
              <div className="flex w-full justify-between">
                ...
                <div className="text-[#0B132A] font-bold">{order.phoneNumber ? order.phoneNumber :"-"}</div>
              </div>
            </div>
            <div className="flex items-center p-4 gap-2 border-b-2">
            ...
            <div className="flex items-center p-4 gap-2 border-b-2">
              ...
              <div className="flex w-full justify-between">
                ...
                <div className="text-[#0B132A] font-bold">{order.orderType}</div>
              </div>
            </div>
            ...
            <div className="flex items-center justify-between p-4 gap-2">
              ...
              <div className="text-[#FF8906] font-bold">IDR. {(order.price * order.quantity).toLocaleString("id")}</div>
            </div>
          </div>
